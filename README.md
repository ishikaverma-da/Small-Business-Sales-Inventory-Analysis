...
## Dataset
The dataset includes customer, products, order, and orderdetails stored in CSV format.
...
## Status
Project in progress. SQL analysis and Power BI dashboard will be added.
